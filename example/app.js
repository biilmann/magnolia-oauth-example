...
const magnoliaTokenInput = document.getElementById('magnolia-token');
...
function submitClientId(e) {
  ...
  var magnoliaToken = magnoliaTokenInput.value;
  if (clientId) {
    ...
    authLink.href = appURL + '/start/deploy?' +
        ...
        '&state=' + state +
        '&repository=https://github.com/biilmann/magnolia-deploy-demo' +
        '#MAGNOLIA_API_TOKEN=' + encodeURIComponent(magnoliaToken);
    setCurrentStep(2);
  }
}
